...
<head>
<meta charset="UTF-8">
<title>KJW Health - 레시피 상세페이지</title>
	...
	<div id="wrap">
		...
		<div class="d-flex justify-content-between align-items-center mt-3">
			<blockquote class="blockquote mt-3">
				<h3><p class="mb-0">개인별 식단 레시피 추천</p></h3>
		...
		<div class="mt-3">
			<c:forEach var="diet" items="${dietList }" varStatus="status">
				<div class="d-flex mt-3">
					<img src="${diet.imagePath }" width="300px" height="300px" class="img-thumbnail" alt="Cinque Terre">
					<div class="detail-recipe form-control ml-4">
